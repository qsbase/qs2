...
qs_save <- function(object, file, compress_level = 3L, shuffle = TRUE, store_checksum = FALSE, nthreads = 1L) {
...
qd_save <- function(object, file, compress_level = 3L, shuffle = TRUE, store_checksum = FALSE, warn_unsupported_types = TRUE, nthreads = 1L) {
