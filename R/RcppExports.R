...
qs_save <- function(object, file, compress_level = 3L, shuffle = TRUE, store_checksum = TRUE, nthreads = 1L) {
    invisible(.Call(`_qs2_qs_save`, object, file, compress_level, shuffle, store_checksum, nthreads))
}

qs_read <- function(file, validate_checksum = TRUE, nthreads = 1L) {
    .Call(`_qs2_qs_read`, file, validate_checksum, nthreads)
}

qd_save <- function(object, file, compress_level = 3L, shuffle = TRUE, store_checksum = TRUE, warn_unsupported_types = TRUE, nthreads = 1L) {
    invisible(.Call(`_qs2_qd_save`, object, file, compress_level, shuffle, store_checksum, warn_unsupported_types, nthreads))
}
